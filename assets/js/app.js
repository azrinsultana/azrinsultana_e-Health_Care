...
$(document).ready(function($) {
	...
	$(function(){
		...
		*/
		...
		function check_name(){
			var username=$("#d_doctorName").val().length;
			if(username==0){
			
			 $("#username_error-message").html("Name can not be empty") ;
			 $("#username_error-message").css("color","red") ;
			 $("#username_error-message").show();
			 error_name=true;
		    
			}
			else if(username.lengh<2 && username.length>20){
				$("#username_error-message").html("Enter valid name") ;
				$("#username_error-message").css("color","red") ;
			}
			else{
		...
		function check_day(){
			...
			var day=$("#d_day").val().length;
			
			if($("#d_day").val()===""){
			
			
			 $("#day_error-message").html("Seletct a Day") ;
			 $("#day_error-message").css("color","red") ;
			 $("#day_error-message").show();
			 error_day=true;
